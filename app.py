...
def analyze_video(video_path, user_api_key):
    try:
        ...
        1. **Deep Visual Description**: Describe everything happening in the video. Mention the mood, lighting, camera
        movements, objects, and the sequence of events in detail.

        2. **Temporal Analysis**: Explain how the scenes transition and the flow of the story/action.

        3. **AI Generation Prompts**: Generate 3 high-quality prompts (for Sora, Runway Gen-2, or Midjourney) that can
        recreate the style, vibe, and visuals of this video. Make the prompts professional and detailed.
